...
public class CatShardsRequest  implements XContentable<CatShardsRequest> {
  ...
  static {
    PARSER.declareObject(CatShardsRequest::setBytes, (p, t) -> Bytes.PARSER.apply(p, null), BYTES);
    ...
    PARSER.declareObject(CatShardsRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
