...
public class CatTemplatesRequest  implements XContentable<CatTemplatesRequest> {
  ...
  public static final ConstructingObjectParser<CatTemplatesRequest, Void> PARSER =
    new ConstructingObjectParser<>(CatTemplatesRequest.class.getName(), false, args -> new CatTemplatesRequest());
  ...
  static {
    ...
    PARSER.declareObject(CatTemplatesRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
