...
public class CatNodeAttributesResponse  implements XContentable<CatNodeAttributesResponse> {
  ...
  public static final ConstructingObjectParser<CatNodeAttributesResponse, Void> PARSER =
    new ConstructingObjectParser<>(CatNodeAttributesResponse.class.getName(), false, args -> new CatNodeAttributesResponse());

  static {
    PARSER.declareObjectArray(CatNodeAttributesResponse::setRecords, (p, t) -> CatNodeAttributesRecord.PARSER.apply(p), RECORDS);
  }
