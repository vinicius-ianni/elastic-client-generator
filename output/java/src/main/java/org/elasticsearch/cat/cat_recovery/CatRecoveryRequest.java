...
public class CatRecoveryRequest  {
  ...
  public CatRecoveryRequest setHeaders(String[] val) { this._headers = val; return this; }
  ...
  public CatRecoveryRequest setSortByColumns(String[] val) { this._sortByColumns = val; return this; }
