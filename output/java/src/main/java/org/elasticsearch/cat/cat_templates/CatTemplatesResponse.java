...
public class CatTemplatesResponse  implements XContentable<CatTemplatesResponse> {
  ...
  public static final ConstructingObjectParser<CatTemplatesResponse, Void> PARSER =
    new ConstructingObjectParser<>(CatTemplatesResponse.class.getName(), false, args -> new CatTemplatesResponse());

  static {
    PARSER.declareObjectArray(CatTemplatesResponse::setRecords, (p, t) -> CatTemplatesRecord.PARSER.apply(p), RECORDS);
  }
