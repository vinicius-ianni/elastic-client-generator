...
public class DeletePipelineRequest  implements XContentable<DeletePipelineRequest> {
  ...
  static {
    PARSER.declareObject(DeletePipelineRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(DeletePipelineRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
  }
