...
public class QuerySqlRequest  implements XContentable<QuerySqlRequest> {
  ...
  static {
    ...
    PARSER.declareInteger(QuerySqlRequest::setFetchSize, FETCH_SIZE);
    PARSER.declareObject(QuerySqlRequest::setFilter, (p, t) -> QueryContainer.PARSER.apply(p, null), FILTER);
