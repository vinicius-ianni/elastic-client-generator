...
public class RuleCondition  implements XContentable<RuleCondition> {
  ...
  static {
    PARSER.declareObject(RuleCondition::setAppliesTo, (p, t) -> AppliesTo.PARSER.apply(p, null), APPLIES_TO);
    PARSER.declareObject(RuleCondition::setOperator, (p, t) -> ConditionOperator.PARSER.apply(p, null), OPERATOR);
