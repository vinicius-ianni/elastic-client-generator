...
public class AlertingUsage  implements XContentable<AlertingUsage> {
  ...
  static {
    PARSER.declareObject(AlertingUsage::setCount, (p, t) -> AlertingCount.PARSER.apply(p, null), COUNT);
    PARSER.declareObject(AlertingUsage::setExecution, (p, t) -> AlertingExecution.PARSER.apply(p, null), EXECUTION);
    PARSER.declareObject(AlertingUsage::setWatch, (p, t) -> AlertingInput.PARSER.apply(p, null), WATCH);
  }
