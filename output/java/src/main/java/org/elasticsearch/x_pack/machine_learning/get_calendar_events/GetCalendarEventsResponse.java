...
public class GetCalendarEventsResponse  implements XContentable<GetCalendarEventsResponse> {
  ...
  static {
    PARSER.declareInteger(GetCalendarEventsResponse::setCount, COUNT);
    PARSER.declareObjectArray(GetCalendarEventsResponse::setEvents, (p, t) -> ScheduledEvent.PARSER.apply(p), EVENTS);
  }
