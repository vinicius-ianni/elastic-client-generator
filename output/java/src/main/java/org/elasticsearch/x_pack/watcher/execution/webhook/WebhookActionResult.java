...
public class WebhookActionResult  implements XContentable<WebhookActionResult> {
  ...
  static {
    PARSER.declareObject(WebhookActionResult::setRequest, (p, t) -> HttpInputRequestResult.PARSER.apply(p, null), REQUEST);
    PARSER.declareObject(WebhookActionResult::setResponse, (p, t) -> HttpInputResponseResult.PARSER.apply(p, null), RESPONSE);
  }
