...
public class AnomalyDetectors  implements XContentable<AnomalyDetectors> {
  ...
  static {
    ...
    PARSER.declareInteger(AnomalyDetectors::setCategorizationExamplesLimit, CATEGORIZATION_EXAMPLES_LIMIT);
    PARSER.declareInteger(AnomalyDetectors::setModelSnapshotRetentionDays, MODEL_SNAPSHOT_RETENTION_DAYS);
  }
