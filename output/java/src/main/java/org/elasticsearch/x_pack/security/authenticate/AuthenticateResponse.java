...
public class AuthenticateResponse  implements XContentable<AuthenticateResponse> {
  ...
  static {
    ...
    PARSER.declareObject(AuthenticateResponse::setAuthenticationRealm, (p, t) -> RealmInfo.PARSER.apply(p, null), AUTHENTICATION_REALM);
    PARSER.declareObject(AuthenticateResponse::setLookupRealm, (p, t) -> RealmInfo.PARSER.apply(p, null), LOOKUP_REALM);
  }
