...
public class IlmUsage  implements XContentable<IlmUsage> {
  ...
  static {
    PARSER.declareInteger(IlmUsage::setPolicyCount, POLICY_COUNT);
    PARSER.declareObjectArray(IlmUsage::setPolicyStats, (p, t) -> IlmPolicyStatistics.PARSER.apply(p), POLICY_STATS);
  }
