...
public class PutPrivilegesRequest  implements XContentable<PutPrivilegesRequest> {
  ...
  static {
    PARSER.declareObject(PutPrivilegesRequest::setRefresh, (p, t) -> Refresh.PARSER.apply(p, null), REFRESH);
    PARSER.declareObject(PutPrivilegesRequest::setApplications, (p, t) ->  new NamedContainer<>(n -> () -> n,UNSUPPORTED), APPLICATIONS);;
  }
