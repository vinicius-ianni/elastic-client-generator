...
public class SnapshotLifecyclePolicy  implements XContentable<SnapshotLifecyclePolicy> {
  ...
  static {
    PARSER.declareObject(SnapshotLifecyclePolicy::setConfig, (p, t) -> SnapshotLifecycleConfig.PARSER.apply(p, null), CONFIG);
    ...
    PARSER.declareObject(SnapshotLifecyclePolicy::setSchedule, (p, t) -> CronExpression.PARSER.apply(p, null), SCHEDULE);
  }
