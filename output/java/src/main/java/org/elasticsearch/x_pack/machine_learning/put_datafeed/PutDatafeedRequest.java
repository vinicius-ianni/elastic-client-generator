...
public class PutDatafeedRequest  implements XContentable<PutDatafeedRequest> {
  ...
  static {
    ...
    PARSER.declareObject(PutDatafeedRequest::setChunkingConfig, (p, t) -> ChunkingConfig.PARSER.apply(p, null), CHUNKING_CONFIG);
    PARSER.declareObject(PutDatafeedRequest::setFrequency, (p, t) -> Time.PARSER.apply(p, null), FREQUENCY);
    PARSER.declareIndices(PutDatafeedRequest::setIndices, (p, t) -> Indices.createFrom(p), INDICES);
    PARSER.declareId(PutDatafeedRequest::setJobId, (p, t) -> Id.createFrom(p), JOB_ID);
    PARSER.declareObject(PutDatafeedRequest::setQuery, (p, t) -> QueryContainer.PARSER.apply(p, null), QUERY);
    PARSER.declareObject(PutDatafeedRequest::setQueryDelay, (p, t) -> Time.PARSER.apply(p, null), QUERY_DELAY);
    ...
    PARSER.declareInteger(PutDatafeedRequest::setScrollSize, SCROLL_SIZE);
  }
