...
public class CcrUsage  implements XContentable<CcrUsage> {
  ...
  static {
    PARSER.declareInteger(CcrUsage::setAutoFollowPatternsCount, AUTO_FOLLOW_PATTERNS_COUNT);
    PARSER.declareInteger(CcrUsage::setFollowerIndicesCount, FOLLOWER_INDICES_COUNT);
  }
