...
public class ChunkingConfig  implements XContentable<ChunkingConfig> {
  ...
  static {
    PARSER.declareObject(ChunkingConfig::setMode, (p, t) -> ChunkingMode.PARSER.apply(p, null), MODE);
    PARSER.declareObject(ChunkingConfig::setTimeSpan, (p, t) -> Time.PARSER.apply(p, null), TIME_SPAN);
  }
