...
public class DeleteRepositoryRequest  implements XContentable<DeleteRepositoryRequest> {
  ...
  static {
    PARSER.declareObject(DeleteRepositoryRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(DeleteRepositoryRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
  }
