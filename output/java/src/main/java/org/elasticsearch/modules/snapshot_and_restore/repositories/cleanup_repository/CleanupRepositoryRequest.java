...
public class CleanupRepositoryRequest  implements XContentable<CleanupRepositoryRequest> {
  ...
  static {
    PARSER.declareObject(CleanupRepositoryRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(CleanupRepositoryRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
  }
