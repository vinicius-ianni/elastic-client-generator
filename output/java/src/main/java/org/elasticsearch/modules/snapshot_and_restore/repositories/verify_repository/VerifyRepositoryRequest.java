...
public class VerifyRepositoryRequest  implements XContentable<VerifyRepositoryRequest> {
  ...
  static {
    PARSER.declareObject(VerifyRepositoryRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(VerifyRepositoryRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
  }
