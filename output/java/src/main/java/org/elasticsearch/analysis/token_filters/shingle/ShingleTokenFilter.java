...
public class ShingleTokenFilter  implements XContentable<ShingleTokenFilter> {
  ...
  static {
    ...
    PARSER.declareInteger(ShingleTokenFilter::setMaxShingleSize, MAX_SHINGLE_SIZE);
    PARSER.declareInteger(ShingleTokenFilter::setMinShingleSize, MIN_SHINGLE_SIZE);
