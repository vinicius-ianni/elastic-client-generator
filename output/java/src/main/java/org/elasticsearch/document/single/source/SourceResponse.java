...
public class SourceResponse<TDocument>  implements XContentable<SourceResponse> {
  ...
  static {
    PARSER.declareObject(SourceResponse::setBody, (p, t) -> TDocument.PARSER.apply(p, null), BODY);
  }
