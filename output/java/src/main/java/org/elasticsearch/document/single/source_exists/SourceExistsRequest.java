...
public class SourceExistsRequest  implements XContentable<SourceExistsRequest> {
  ...
  static {
    ...
    PARSER.declareRouting(SourceExistsRequest::setRouting, (p, t) -> Routing.createFrom(p), ROUTING);
    PARSER.declareBoolean(SourceExistsRequest::setSourceEnabled, SOURCE_ENABLED);
    PARSER.declareObjectArray(SourceExistsRequest::setSourceExcludes, (p, t) -> Field.PARSER.apply(p), SOURCE_EXCLUDES);
    PARSER.declareObjectArray(SourceExistsRequest::setSourceIncludes, (p, t) -> Field.PARSER.apply(p), SOURCE_INCLUDES);
    PARSER.declareLong(SourceExistsRequest::setVersion, VERSION);
    PARSER.declareObject(SourceExistsRequest::setVersionType, (p, t) -> VersionType.PARSER.apply(p, null), VERSION_TYPE);
  }
