...
public class CloneIndexRequest  implements XContentable<CloneIndexRequest> {
  ...
  static {
    ...
    PARSER.declareObject(CloneIndexRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(CloneIndexRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
