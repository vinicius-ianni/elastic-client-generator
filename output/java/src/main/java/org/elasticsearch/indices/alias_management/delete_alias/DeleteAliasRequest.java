...
public class DeleteAliasRequest  implements XContentable<DeleteAliasRequest> {
  ...
  static {
    PARSER.declareObject(DeleteAliasRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(DeleteAliasRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
  }
