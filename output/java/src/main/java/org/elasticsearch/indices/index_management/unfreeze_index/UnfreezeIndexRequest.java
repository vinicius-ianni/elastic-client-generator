...
public class UnfreezeIndexRequest  implements XContentable<UnfreezeIndexRequest> {
  ...
  public static final ConstructingObjectParser<UnfreezeIndexRequest, Void> PARSER =
    new ConstructingObjectParser<>(UnfreezeIndexRequest.class.getName(), false, args -> new UnfreezeIndexRequest());

  static {
    PARSER.declareBoolean(UnfreezeIndexRequest::setAllowNoIndices, ALLOW_NO_INDICES);
    PARSER.declareObject(UnfreezeIndexRequest::setExpandWildcards, (p, t) -> ExpandWildcards.PARSER.apply(p, null), EXPAND_WILDCARDS);
    PARSER.declareBoolean(UnfreezeIndexRequest::setIgnoreUnavailable, IGNORE_UNAVAILABLE);
    PARSER.declareObject(UnfreezeIndexRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(UnfreezeIndexRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
