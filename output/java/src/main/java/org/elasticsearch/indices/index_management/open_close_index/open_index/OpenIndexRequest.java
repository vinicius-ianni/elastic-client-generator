...
public class OpenIndexRequest  implements XContentable<OpenIndexRequest> {
  ...
  @Override
  public OpenIndexRequest fromXContent(XContentParser parser) throws IOException, XContentParseException {
  ...
  static {
    ...
    PARSER.declareObject(OpenIndexRequest::setExpandWildcards, (p, t) -> ExpandWildcards.PARSER.apply(p, null), EXPAND_WILDCARDS);
    PARSER.declareBoolean(OpenIndexRequest::setIgnoreUnavailable, IGNORE_UNAVAILABLE);
    PARSER.declareObject(OpenIndexRequest::setMasterTimeout, (p, t) -> Time.PARSER.apply(p, null), MASTER_TIMEOUT);
    PARSER.declareObject(OpenIndexRequest::setTimeout, (p, t) -> Time.PARSER.apply(p, null), TIMEOUT);
