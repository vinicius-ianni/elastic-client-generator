...
public class NodeInfoNetwork  implements XContentable<NodeInfoNetwork> {
  ...
  static {
    PARSER.declareObject(NodeInfoNetwork::setPrimaryInterface, (p, t) -> NodeInfoNetworkInterface.PARSER.apply(p, null), PRIMARY_INTERFACE);
    PARSER.declareInteger(NodeInfoNetwork::setRefreshInterval, REFRESH_INTERVAL);
  }
