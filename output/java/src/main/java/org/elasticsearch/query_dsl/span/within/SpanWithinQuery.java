...
public class SpanWithinQuery  implements XContentable<SpanWithinQuery> {
  ...
  static {
    PARSER.declareObject(SpanWithinQuery::setBig, (p, t) -> SpanQuery.PARSER.apply(p, null), BIG);
    PARSER.declareObject(SpanWithinQuery::setLittle, (p, t) -> SpanQuery.PARSER.apply(p, null), LITTLE);
  }
