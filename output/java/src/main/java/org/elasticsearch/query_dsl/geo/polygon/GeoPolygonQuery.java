...
public class GeoPolygonQuery  implements XContentable<GeoPolygonQuery> {
  ...
  static {
    PARSER.declareObjectArray(GeoPolygonQuery::setPoints, (p, t) -> GeoLocation.PARSER.apply(p), POINTS);
    PARSER.declareObject(GeoPolygonQuery::setValidationMethod, (p, t) -> GeoValidationMethod.PARSER.apply(p, null), VALIDATION_METHOD);
  }
